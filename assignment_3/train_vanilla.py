...
def train_vanilla_model(data_dir):
    ...
    generate_predictions(model, test_dataset, device, 'predictions_vanilla', 'vanilla', config['beam_width'])
    
    return model, train_dataset, test_acc, beam_acc

if __name__ == '__main__':
    train_vanilla_model('data/dakshina_dataset_v1.0/hi/lexicons/')
